        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light p-0">
                <a href="#hero" class="navbar-brand">
                    <h2 class="text-green">AJI'E SHAMPO</h2>
                </a>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                        ...
                        <p class="mb-4">Shampo herbal adalah produk perawatan rambut yang terbuat dari bahan-bahan alami seperti ekstrak tumbuhan, minyak esensial, dan bahan organik lainnya. Tujuan utama penggunaan shampo herbal adalah untuk menjaga kesehatan rambut dan kulit kepala tanpa menggunakan bahan kimia keras yang sering ditemukan dalam shampo konvensional.</p>
                        <p class="mb-4"></p>
        ...
        <div class="best">
            <div class="container">
                <div class="mx-auto text-center wow fadeIn" data-wow-delay="0.1s" style="max-width: 600px;">
                    <h1 class="text-a"><span class="fw-light text-dark">Best Benefits Of Our</span> Natural Hair Shampoo</h1>
                    <!-- <p class="mb-5"></p> -->
                </div>
                    ...
                    <div class="col-lg-4 wow fadeIn" data-wow-delay="0.3s">
                        <div class="row g-5">
                            ...
                            <div class="col-12 d-flex">
                                ...
                                <div class="ps-3">
                                    <h5>Rambut Bebas dari Bahan Kimia</h5>
                                    <hr class="w-25 bg-primary my-2">
                                    <span></span>
                                </div>
                            </div>
                ...
                @foreach ($products as $product)
                    <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.1s">
                        <div class="product-item text-center border h-100 p-4">
                            ...
                            <h5 class="text-primary mb-3">Rp {{ $product->price }}</h5>
